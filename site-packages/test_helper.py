        ...
        if count == 1:
            ...
            while True:
                try:
                    ...
                    if not silent:
                        _write_error("+++",scriptname, output+display_order)
                        _write_html_row(scriptname,func.__name__+display_order, image, "Success", screenshot)
                    #if image_updating:
                    ...
                    if image_updating:
                        ...
                        _write_error("---",scriptname, output+display_order)
                        _write_html_row(scriptname,func.__name__+display_order, image, "Fail", screenshot)
                        raise
                except:
                    raise
        else:
