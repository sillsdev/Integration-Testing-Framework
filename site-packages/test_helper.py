...
def simpleCompare(image1,image2):
    bf = image1 #BIG find
    ...
    def wrapper(*args, **kwargs):
        ...
        if count == 1:
            ...
            if isinstance(args[0],SikuliRegion):
                ...
                area = sikuli.SCREEN
                specific_area = False
            if isinstance(image, sikuli.Pattern):
            ...
            while True:
                try:
                    ...
                    fname = func.__name__
                    if specific_area or fname == "type" or fname == "paste" or fname == "onChange" or fname == "observe":
                    ...
                    if not silent:
                        _write_error("+++",scriptname, output)
                    ...
                    screenshot = area.getLastScreenImageFile(tempfile.gettempdir(), imageName)
                    similarity = simpleCompare(screenshot, image)
                    if image_updating:
...
def init():
    ...
    my_OSVersion = sikuli.Env.getOSVersion()
    if my_OS == sikuli.OS.LINUX:
        ...
        os_options = {
        "3.2.0-102-generic": "UbuntuPrecise",
        "3.13.0-76-generic": "UbuntuTrusty",
        "4.4.0-22-generic" : "UbuntuXenial",
        "3.8.0-35-generic" : "Wasta12",
        "3.16.0-29-generic": "Wasta14"
        }
    ...
    if not os.path.exists(myImagesPath):
        error_message = "ERROR: The following Common Image Path is missing: "+myImagesPath
        print error_message
        ...
        if choice == -1:
            ...
            try:
                ...
                popup(myImagesPath+" could not be created.")
        elif choice == 1:
            pass
        elif choice == 2:
            exit(1)
    ...
    error_file = os.path.join(log_folder,"error_log")
