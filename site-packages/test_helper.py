...
def generateHTMLforRun(func):
    def runHTMLwrapper(*args, **kwargs):
...
#helpers = os.path.join(wd, "helpers")
#print "*********Helper Folder: ",helpers
...
with open(os.path.join(SitePackages, "logFolder.txt"), "a+") as f:
    rawLogFolder = (f.readline()).strip()
if rawLogFolder == "vagrant":
